...
export const sv: Readonly<Record<string, string>> = {
  ...
  "smoke.status.app": "Appuppdatering {id}, publicerad {date, date, short} {date, time, short}",
  "smoke.status.commit": "commit {commit}",
  "smoke.status.database": "databas {db} · migreringar {migrations}",
  "smoke.status.embedded": "Appens kod kommer från bygget, ingen uppdatering har hämtats",
