...
export const fi: Readonly<Record<string, string>> = {
  ...
  "smoke.status.app": "Sovelluksen päivitys {id}, julkaistu {date, date, short} {date, time, short}",
  "smoke.status.commit": "commit {commit}",
  "smoke.status.database": "tietokanta {db} · migraatiot {migrations}",
  "smoke.status.embedded": "Sovelluksen koodi on peräisin rakennuksesta, päivitystä ei ole otettu käyttöön",
