...
Contributions are accepted under the Developer Certificate of Origin. Every commit needs a `Signed-off-by` line, added with `git commit -s`. Details in [CONTRIBUTING.md](CONTRIBUTING.md) and the [DCO](DCO) file.
